...
*/
const NULL_CHAR = "\0";
const CORPORATION_UNSET_VALUE_PATHS = [
  `HKCU\\Software\\ROBLOX Corporation\\${NULL_CHAR}`,
  `HKCU\\Software\\ROBLOX Corporation\\Environments\\${NULL_CHAR}`,
];
...
const STUDIO_PLACE_UNSET_VALUE_PATHS = [
  `HKCU\\Software\\Classes\\Roblox.Place\\shell\\${NULL_CHAR}`,
];
    ...
    "HKCU\\Software\\ROBLOX Corporation\\Environments\\roblox-player\\Capabilities":
      {
        ...
        ApplicationIcon: {
          value: playerApplicationIconPath,
          type: "REG_EXPAND_SZ",
        },
